  ...
  return (
    <section className="py-12 sm:py-20 px-4 relative z-10" id="comparison">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div
          ref={containerRef}
          className="relative w-full aspect-[1638/2048] md:aspect-[1638/684] rounded-3xl overflow-hidden border border-[#00f2ff]/20 shadow-[0_0_50px_rgba(0,242,255,0.08)] select-none"
        >
          {/* Label Before (Left) */}
