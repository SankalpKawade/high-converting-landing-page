...
const faqs = [
  {
    ...
    a: 'You get 70GB+ of professional video editing assets across 28+ Packs — including LUTs, transitions, overlays, sound effects, music, motion graphics, templates, fonts, stock footage, and much more. Plus 4 exclusive bonuses worth ₹3,696!',
  },
  {
