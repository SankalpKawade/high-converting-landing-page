...
export default function HeroSection() {
  return (
    <section className="relative h-[100dvh] flex flex-col pt-[88px] sm:pt-[100px] pb-6 sm:pb-10 px-4 overflow-hidden grid-bg" id="hero">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 flex-1 flex flex-col justify-center items-center gap-5 sm:gap-7 w-full pb-[4vh]">
        ...
        <div className="text-center mt-3 sm:mt-5 shrink-0 w-full">
          <a
            href={CTA_URL}
            className="block w-full max-w-[340px] mx-auto sm:inline-block sm:w-auto sm:max-w-none btn-cta text-[16px] sm:text-lg font-black px-6 sm:px-12 py-4 sm:py-3.5 rounded-2xl tracking-wide uppercase"
          >
