...
export default function HeroSection() {
  return (
    <section className="relative min-h-[100dvh] flex flex-col justify-center pt-[96px] sm:pt-[108px] pb-6 sm:pb-10 px-4 overflow-hidden grid-bg" id="hero">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10 flex-1 flex flex-col justify-center items-center gap-4 sm:gap-6 w-full">
        {/* Top badge — SOLID background */}
        <div className="inline-flex items-center gap-2 bg-[#0f1629] border border-[#00f2ff]/30 rounded-full px-4 py-1.5 shrink-0">
        ...
        <h1 className="hero-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.05] shrink-0">
        ...
        <p className="text-sm sm:text-base md:text-xl text-[#94a3b8] max-w-2xl mx-auto leading-relaxed shrink-0">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-6 shrink-0">
        ...
        {/* CTA */}
        <div className="text-center mt-2 sm:mt-4 shrink-0 w-full">
          <a
            href={CTA_URL}
            className="block w-full max-w-[340px] mx-auto sm:inline-block sm:w-auto sm:max-w-none btn-cta text-[15px] sm:text-lg font-black px-6 sm:px-12 py-3.5 sm:py-3.5 rounded-2xl tracking-wide uppercase"
          >
