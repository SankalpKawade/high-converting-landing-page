...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col justify-start sm:justify-center pt-[140px] sm:pt-[180px] pb-6 sm:pb-10 px-4 sm:px-6 lg:px-8 text-center overflow-hidden grid-bg" id="hero">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 flex-1 flex flex-col justify-start sm:justify-center items-center w-full mt-1 sm:mt-3">
        ...
        <div className="inline-flex items-center gap-2 bg-[#0f1629] border border-[#00f2ff]/30 rounded-full px-4 py-1.5 mb-6 sm:mb-10 shrink-0 min-w-[280px] sm:min-w-[320px] justify-center">
